public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: The list should start at index 0 not 1
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: //It was adding in front of the queue but it must be at the end.
    ...
    private void Enqueue(int value) {
        _queue.Add(value); //It was adding in front of the queue but it must be at the end.
    }
